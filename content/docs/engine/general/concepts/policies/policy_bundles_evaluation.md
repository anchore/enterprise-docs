...
- [Policies](/docs/engine/general/concepts/policies/policies) -  The named sets of rules and actions
- [Whitelists](/docs/engine/general/concepts/policies/whitelists) - Named sets of rule exclusions to override a match in a policy rule
- [Mappings](/docs/engine/general/concepts/policies/policy_mappings) - Ordered rules that determine which policies and whitelists should be applied to a specific image at evaluation time.
