...
In this section you will learn how to add images to Anchore for analysis. You can refer to the [Image Analysis Process](/docs/overview/concepts/image_analysis_process) document in the concepts section if you are not familiar with how scanning images with Anchore works. 
